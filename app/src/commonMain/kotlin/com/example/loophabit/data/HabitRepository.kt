...
import com.example.loophabit.data.SyncManager
...
class HabitRepository(
    ...
    val syncState: Flow<com.example.loophabit.data.SyncState> = syncManager?.syncState ?: MutableStateFlow(com.example.loophabit.data.SyncState.Idle).asStateFlow()
    ...
    val focusStateFlow: Flow<LoopPreferences.FocusState> = loopPreferences.focusStateFlow

    suspend fun saveFocusState(state: LoopPreferences.FocusState) {
