...
class LoopHabitApp : Application() {
    ...
    val database by lazy { com.example.loophabit.data.createDatabaseBuilder(this).build() }
    val preferences by lazy { 
        com.example.loophabit.data.LoopPreferencesHolder.init(this)
        LoopPreferences(com.example.loophabit.data.createPlatformSettings()) 
    }
